...
public final class ExtractorMenu extends AbstractContainerMenu {
    ...
    public ExtractorMenu(int containerId, Inventory playerInventory, FriendlyByteBuf buffer) {
        this(containerId, playerInventory, (ExtractorBlockEntity) playerInventory.player.level().getBlockEntity(buffer.readBlockPos()), null);
    }

    public ExtractorMenu(int containerId, Inventory playerInventory, ExtractorBlockEntity blockEntity, ContainerData data) {
        ...
        addSlot(new MachineResultSlot(blockEntity.getInventory(), 1, 111, 30, () -> {
        }));
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), player, IC2Blocks.EXTRACTOR.get());
    }
