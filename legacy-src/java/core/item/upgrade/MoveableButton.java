...
class MoveableButton extends VanillaButton
{
    ...
    public MoveableButton(final GuiIC2<?> gui, final int normalX, final int normalY, final int shiftedX, final int shiftedY, final int width, final int height, final IClickHandler handler) {
    ...
    public MoveableButton withMoveHandler(final IEnableHandler moveHandler) {
